...
from pretalx.common.models.mixins import LogMixin, PretalxModel
...
class Tour(PretalxModel):
    ...
    event = models.ForeignKey(Event, on_delete=models.CASCADE, related_name="hitalx_tours")
